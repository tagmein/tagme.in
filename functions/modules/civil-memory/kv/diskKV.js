...
function diskKV(_a) {
    var rootDir = _a.rootDir, fsPromises = _a.fsPromises, path = _a.path;
    var isInitialized = false;
    function diskPath(namespace, key) {
        return __awaiter(this, void 0, void 0, function () {
            var namespaceDirPath;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            _c.trys.push([1, 4, , 5]);
                            _b = (_a = fsPromises).readFile;
                            return [4 /*yield*/, diskPath(namespace, key)];
                        case 2: return [4 /*yield*/, _b.apply(_a, [_c.sent()])];
                        case 3: return [2 /*return*/, (_c.sent()).toString('utf8')];
                        case 4:
                            e_2 = _c.sent();
